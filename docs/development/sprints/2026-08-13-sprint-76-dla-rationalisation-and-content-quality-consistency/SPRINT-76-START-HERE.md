...
Strategic quality direction: move PRISM toward resources that benchmark in the **mid-90s consistently** by improving underlying educational/resource quality — not by gaming the benchmark.

**RECOVER** any regression from the Sprint 71 known-good historical quality baseline, then **ADVANCE** remaining task–material / richness work. Regression is an investigation **hypothesis**, not an established finding.
...
| Doc | Role |
| --- | ---- |
| [SPRINT-76-CHARTER.md](SPRINT-76-CHARTER.md) | Mission, boundaries, success direction |
| [CONTEXT.md](CONTEXT.md) | Investigation evidence and working hypotheses |
| [PLAN.md](PLAN.md) | Phases and task definitions |
| [STATUS.md](STATUS.md) | Authoritative current snapshot |
| [decisions.md](decisions.md) | `S76-D##` decision log |
