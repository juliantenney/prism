...
(function (root, factory) {
  ...
  var PROCEDURAL_OPENING_RE =
    /^(Identify|Analyse|Analyze|Examine|Establish|Complete|Bring together|Study the|No model row|In this activity you will|You will now|Now complete)\b/i;
  ...
  var AUTHORIAL_PURPOSE_LINES = [
    "- ACTIVITY_PREAMBLE AUTHORIAL PURPOSE (1–3 sentences, topic-specific):",
    ...
    "  3. Connect to prior learning where appropriate — build on the previous activity's reasoning.",
    "  4. Create intellectual momentum — why this step follows from what came before.",
    "  5. Prepare thinking before task execution — orient inquiry, not workflow."
  ];
  ...
  var PREFER_AVOID_LINES = [
    ...
    "- AVOID: task summaries, scaffolding state labels, workflow instructions, and stage directions that belong in learner_task or materials.",
