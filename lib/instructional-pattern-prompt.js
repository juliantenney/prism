...
(function (root, factory) {
  ...
  var SP02_LINES = [
    ...
    "- When emitting Material: ... (decision_table): model evidence-gathering on one partial exemplar row before learner judgement.",
    "- Populate evidence/reasoning cells on the exemplar row only; remaining rows leave those cells empty for learner completion.",
    "- Judgement / decision / rating columns MUST stay empty on every row, including the exemplar row — learner owns evaluative conclusions (MP-1).",
    "- Do not pre-fill Correct/Incorrect, Impact, rank ordinals, or final judgements in learner-owned columns.",
    "- Substantive exemplar reasoning on one row — not a table shell with only empty cells (remediates FM-04).",
