...
(function (root, factory) {
  ...
  function (populationContract, beatRegistry, instructionalArchetype, activityTitleContract) {
    ...
    function looksLikeSourcePropertyOrTextualEvidenceAnalysis(joined) {
      return /\b(formal features?|textual features?|imagery|tone|structure|poetic form|language features?|lineation|stanza|metre|meter|quotations?|excerpts?|source (?:material|text|properties)|close[- ]read|poems?|from the poems?)\b/.test(
        joined
      );
    }
