...
(function (root, factory) {
  ...
  var CORE_LINES = [
    ...
    "- Module: " +
      MODULE_ID +
      " | L0–L3 read-only page compose + L5 field preservation. Obey appended LD-MATERIALS-COPY, LD-TABLE-FIDELITY, LD-SELF-DIRECTED-RHETORIC, LD-MATH-RENDER, and Sprint 38 visual/pedagogical contracts — bodies not repeated here."
  ];
  ...
  var MATERIALS_BRIDGE_LINES = [
    "- MATERIALS FIDELITY (compose): visual_affordances[] are additive page-root metadata only — must not replace learning_activities.content[].materials; representation_avoid / duplicate rules on generated figures only; L4 preserve embed:"
  ];
