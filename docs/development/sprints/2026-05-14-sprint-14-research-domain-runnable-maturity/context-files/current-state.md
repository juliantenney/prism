...
- **Sprint 14 — Research Domain Runnable Maturity** (**active focus**): make **Research** workflows **usable and trustworthy** as a runnable Factory domain—**not** an architecture portability sprint. **Map / charter / baseline / known issues:** `docs/consolidation/sprint-14-index.md`, `sprint-14-charter.md`, `sprint-14-research-pack-baseline-audit.md`, `sprint-14-current-known-issues.md`. **Context:** **General baseline-only** clarification is **documented** (`sprint-13-general-alwayson-first-structured-domain-behaviour.md` §**Current v1**); **runnable** v1 domains are **Learning Design** and **Research**; Sprint **14** concentrates on **Research** pack + targeted product behaviour. **Later:** **Learning Design** elicitation / parity review is **planned outside Sprint 14** (see charter non-goals). **Sprint 12** and **Sprint 13** first-pass closures remain **unchanged**.
...
- Sprint 14 — **Research Domain Runnable Maturity** — **scaffolding / charter in consolidation** (2026-05-14): index `docs/consolidation/sprint-14-index.md`; charter `sprint-14-charter.md`; baseline audit `sprint-14-research-pack-baseline-audit.md`; known issues `sprint-14-current-known-issues.md`. **Active product focus** on Research runnable trustworthiness; **not** Sprint 13-style portability architecture; **Sprint 12** not reopened. **Learning Design** elicitation review **deferred** beyond Sprint 14 charter.
