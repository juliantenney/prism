# 45-2 Boundary Declaration Annex
...
- Record boundary declarations only.
- Do not score bodies in this file.
- Do not include recommendations in this file.
...
| **Calibration reference** | M22 (Photosynthesis benchmark corpus) — Pass 2 Minimum vs Inter-Rater Failed calibration split |
...
| **Impact on verdict** | Baseline scored Minimum under declared Pass 2 reading despite FM-03 diagnostic flag; treatment scored Strong under same reading. |
| **Impact on pair classification** | Verdict rise (Minimum -> Strong) supports Improvement classification under frozen pair rules. |
| **Notes** | B1 recorded before any Layer 1 verdict on BL-TP-PS-A6 or TR-TP-PS-A6. Frozen M22 historical records not altered. |
