...
- **Status:** **Complete** — CERTIFIED at closeout.

---

## Track B — Learner material canonicalisation audit (Phases 0–8)

Parallel track completing the GAM material type audit on learner-renderer-vNext.

| Phase | Objective | Status |
| ----- | --------- | ------ |
| 0 | Inventory + unsupported ledger | Complete |
| 1 | Alias normalisation | Complete |
| 2–3 | Non-renderable structural/workflow boundaries | Complete |
| 4 | Card family consolidation | Complete |
| 5 | Guarded table/worksheet compatibility | Complete |
| 6 | Support family boundaries | Complete |
| 7 | Strategy → task_card consolidation | Complete |
| 8 | Rubric → checklist consolidation | Complete |

**Outcome:** unsupported learner material types **9 → 3** (table, video, worksheet — intentional).
