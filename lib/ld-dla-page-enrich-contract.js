...
(function (root, factory) {
  ...
  function buildInstructionalArchetypePlanningGuidance() {
    return [
      "Instructional archetype planning on required_materials (Sprint 60 production — Priority 1):",
      "",
      "Authoritative source of truth (per material row):",
      "- instructional_archetype",
      "- archetype_plan",
      "",
      "When a material’s pedagogical job genuinely matches one of the three Priority-1 archetypes,",
      ...
      "- Do not invent unknown instructional_archetype values (Priority-1 only in this contract).",
