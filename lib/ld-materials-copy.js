...
(function (root, factory) {
  ...
  var ARCHIVAL_FIELD_LINES = [
    ...
    "- Transport slots (upstream body or omit; not authored here): knowledge_summary (when LC/KM bound), study_tips (when GAM provides \"### Page learner-resource closure\"), overview and learning_purpose (transport upstream body when present; wrapper-gap fallback obey LD-THIN-ASSEMBLY-COHERENCE-CONTRACT — procedural detail not in this block).",
  ...
  var AUTHOR_LINES = [
    ...
    "- Explanatory text, worked examples, and scenarios: obey LD-GAM-INSTRUCTIONAL-DEPTH-CONTRACT (exemplars are internal generation guidance only — never surface weak/stronger-explanation meta-commentary; subject-matter first; show how conclusions are reached; domain comparative reasoning retained; no Cause:/Mechanism: labels).",
