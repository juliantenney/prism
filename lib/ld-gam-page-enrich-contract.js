  ...
  function buildGamPageEnrichContractBlock() {
    ...
    return [
      ...
      .concat([
        ...
        "- Prefer a consolidation_summary, transfer_prompt, or culminating closure/debrief material when commissioned as the host Markdown vessel; otherwise append the section to the last Markdown material of the final activity.",
        ...
        "- S78-T-041: page learner-resource closure / study_tips is consolidation only. When a transfer_prompt material is commissioned, its body is the distinct learner-production transfer task — do not replace that production with this closure section.",
        "",
