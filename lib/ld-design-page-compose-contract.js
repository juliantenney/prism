...
(function (root, factory) {
  ...
  var FIELD_AUTHORIZING_LINES = [
    "- AUTHORABLE VS ARCHIVAL FIELDS: page narrative (overview, learning_purpose, knowledge_summary, section headings, study_tips, visual_affordance descriptions, wrapper prose) is authorable; learning_activities.content[].materials.* is archival only — obey LD-MATERIALS-COPY AUTHORABLE VS ARCHIVAL FIELDS in the L4 preserve embed below.",
