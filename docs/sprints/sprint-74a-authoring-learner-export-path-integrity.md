...
Establish vNext as the sole learner-renderer implementation; remove the obsolete renderer and redundant paths; verify existing learner-export functionality on the production browser path. One definitive codebase.
