...
**Sprint 74A is COMPLETE / Closed** — [SPRINT-74A-FINAL-REPORT.md](../2026-08-06-sprint-74a-authoring-learner-export-path-integrity/SPRINT-74A-FINAL-REPORT.md). **Sprint 74B is COMPLETE / Closed** — [SPRINT-74B-START-HERE.md](../2026-08-07-sprint-74b-generation-contract-capture-validator-hygiene/SPRINT-74B-START-HERE.md). Sprint 74C remains **Not opened** — see [post-74B review](S74-programme-post-74B-review.md) (Domain C must not proceed unchanged).
