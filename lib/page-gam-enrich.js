...
(function (root, factory) {
  ...
  function bodyDisclosesTargetConclusion(body) {
    return /correct answer is|therefore the answer|you should conclude|a reasonable provisional judgement is|make the strongest contribution|contributes? most strongly|the overall judgement|therefore .* is most important|broadest support|preferred mechanism|provides? the (broadest|strongest)/i.test(
