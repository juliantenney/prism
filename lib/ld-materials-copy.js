...
(function (root, factory) {
  ...
  var ARCHIVAL_FIELD_LINES = [
    "- AUTHORABLE VS ARCHIVAL FIELDS (Design Page):",
    "- Authorable: all page narrative fields — overview, learning_purpose, knowledge_summary, section headings, study_tips, visual_affordance descriptions, and other page-level prose. The coherent learner journey may be authored only here.",
    "- Archival (not authorable): learning_activities.content[].materials.* — exact upstream GAM payload only.",
    ...
    "- The page may interpret, connect, and explain materials in narrative fields — activity.materials.* must remain an exact archival payload copied from upstream GAM.",
