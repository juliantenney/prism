...
var genericMoments = require("./compose-generic-moments");
...
function composeTransferMoment(modelActivity) {
  return genericMoments.composeGenericTransferMoment(modelActivity);
}
...
module.exports = {
  ...
  composeTransferMoment: composeTransferMoment,
