...
**Top-level charter:** [docs/sprints/sprint-76-dla-rationalisation-and-content-quality-consistency.md](../../../sprints/sprint-76-dla-rationalisation-and-content-quality-consistency.md)

| Layer | Authority |
| ----- | --------- |
| **Current truth** | [STATUS.md](STATUS.md) · [decisions.md](decisions.md) |
| **Continuation** | [HANDOVER.md](HANDOVER.md) · [next-chat-briefing.md](next-chat-briefing.md) |
| **Investigation evidence** | [CONTEXT.md](CONTEXT.md) |
