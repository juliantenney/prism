...
(function (root, factory) {
  ...
  var DLA_AUTHORING_LINES = [
    ...
    "- intellectual_coherence_bridge (mandatory every activity including A1; prefer 1–2 concise sentences): A1 connects page orientation/learning purpose to the first activity; A2+ carries prior learning into the current demand; distinct from activity_preamble; see OUTPUT CONTRACT on Design Learning Activities; preserve verbatim through partial Design Page + deterministic assembly.",
