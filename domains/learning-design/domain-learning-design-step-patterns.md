...

{
  ...
  "defaultPromptNotes": "Realise DLA required_materials per GAM-PRES (38J-4 — DLA decides, GAM realises): order/membership GAM-PRES-01/02; types GAM-PRES-03; depth GAM-PRES-08/09/11 (38L-3; S59 Iteration 7 — exemplar-driven quality internalised: no weak/stronger-explanation meta-leakage; subject-matter first; retain Iteration 6 pairs + anti-rubric-gaming); Evaluate trio GAM-PRES-10 + EV-GAM-FAIL-07 (38L-4). Self_directed: LD-TABLE-FIDELITY, LD-MATERIALS-COPY, LD-GAM-INSTRUCTIONAL-DEPTH, LD-SELF-DIRECTED-RHETORIC, LD-MATH-RENDER at runtime. Workbook (38F-2/38E-9): GAM-WB-38F-01 pipe tables; GAM-WB-02/06 per PRES-08; GAM-WB-06b (38H-2). Preserve full pedagogical depth and all required material bodies; do not compress/thin for brevity and do not emit size-limit/split-response disclaimers. FAIL: F1–F9, AP-01/05, DEPTH-COLLAPSE (GAM-PRES-09).",
  "runnerInstructions": {
