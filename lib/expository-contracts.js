...
(function (root, factory) {
  ...
  /**
   * XD: per-section explanatory treatment + material commissions (no Interactive evidence).
   * explanation_intent = how this section achieves its planned conceptual move.
