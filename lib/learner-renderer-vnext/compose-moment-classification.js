...
var TASK_INSTRUCTION_PATTERN =
  /^(Write|Complete the prompt set|Complete the analysis|Complete the decision|Work through|Produce|Draft|Fill in|Enter|Analyse|Analyze|Apply|Decide|Identify|Study|Read the|Use the response template)/i;
