...
**Parent programme:** [Sprint 74](../2026-08-06-sprint-74-architecture-consolidation-and-rationalisation/README.md)  
**Opening:** [S74A-D01](decisions.md)  
...
Establish vNext as Prism’s sole learner-renderer implementation, remove the obsolete renderer and its redundant paths, and verify existing learner-export functionality through the production browser path.
