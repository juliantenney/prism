...
(function (root, factory) {
  ...
  var productionFulfilment = null;
  var practiceIndependence = null;
  var diagnosticReview = null;
  ...
  if (typeof module === "object" && module.exports) {
    ...
    try {
      productionFulfilment = require("./dla-production-fulfilment.js");
    } catch (_) {}
    try {
      practiceIndependence = require("./dla-practice-independence.js");
    } catch (_) {}
    try {
      diagnosticReview = require("./dla-diagnostic-review.js");
    } catch (_) {}
    try {
      responseFields = require("./dla-response-fields.js");
    } catch (_) {}
    try {
    ...
    module.exports = factory(
      ...
      productionFulfilment,
      practiceIndependence,
      diagnosticReview,
      responseFields,
    ...
    diagnosticReview = root.PRISM_DLA_DIAGNOSTIC_REVIEW || null;
    responseFields = root.PRISM_DLA_RESPONSE_FIELDS || null;
    facilitatedDeliveryMod = root.PRISM_DLA_FACILITATED_DELIVERY || null;
  ...
  function (
    ...
    function getProductionFulfilmentLib() {
      if (productionFulfilment) return productionFulfilment;
      var root =
        typeof globalThis !== "undefined"
          ? globalThis
          : typeof window !== "undefined"
          ? window
          : {};
      return root.PRISM_DLA_PRODUCTION_FULFILMENT || null;
    }

    function getPracticeIndependenceLib() {
      if (practiceIndependence) return practiceIndependence;
      var root =
        typeof globalThis !== "undefined"
          ? globalThis
          : typeof window !== "undefined"
          ? window
          : {};
      return root.PRISM_DLA_PRACTICE_INDEPENDENCE || null;
    }

    function getDiagnosticReviewLib() {
      if (diagnosticReview) return diagnosticReview;
      var root =
        typeof globalThis !== "undefined"
          ? globalThis
          : typeof window !== "undefined"
          ? window
          : {};
      return root.PRISM_DLA_DIAGNOSTIC_REVIEW || null;
    }

    function getResponseFieldsLib() {
      if (responseFields) return responseFields;
      var root =
        typeof globalThis !== "undefined"
          ? globalThis
          : typeof window !== "undefined"
          ? window
          : {};
      return root.PRISM_DLA_RESPONSE_FIELDS || null;
    }
    ...
    function validateActivityMaterialContracts(activity, index, errors) {
      ...
      if (Array.isArray(activity && activity.required_materials)) {
        activity.required_materials.forEach(function (required, reqIndex) {
          ...
          if (
            ...
            typeof required === "object" &&
            !Array.isArray(required) &&
            Object.prototype.hasOwnProperty.call(required, "response_fulfilment")
          ) {
            var fulfilmentLib = getProductionFulfilmentLib();
            if (fulfilmentLib && typeof fulfilmentLib.validateResponseFulfilmentShape === "function") {
              fulfilmentLib.validateResponseFulfilmentShape(
                required.response_fulfilment,
                rowPath + ".response_fulfilment",
                errors
              );
            }
          }
          if (
            ...
            typeof required === "object" &&
            !Array.isArray(required) &&
            Object.prototype.hasOwnProperty.call(required, "practice_independence")
          ) {
            var independenceLib = getPracticeIndependenceLib();
            if (
              independenceLib &&
              typeof independenceLib.validatePracticeIndependenceShape === "function"
            ) {
              independenceLib.validatePracticeIndependenceShape(
                required.practice_independence,
          ...
          if (
            ...
            typeof required === "object" &&
            !Array.isArray(required) &&
            Object.prototype.hasOwnProperty.call(required, "diagnostic_review")
          ) {
            var reviewLib = getDiagnosticReviewLib();
            if (reviewLib && typeof reviewLib.validateDiagnosticReviewShape === "function") {
              reviewLib.validateDiagnosticReviewShape(
                required.diagnostic_review,
                rowPath + ".diagnostic_review",
                errors
              );
            }
          }
          if (
            ...
            typeof required === "object" &&
            !Array.isArray(required) &&
            Object.prototype.hasOwnProperty.call(required, "response_fields")
          ) {
            var fieldsLib = getResponseFieldsLib();
            if (fieldsLib && typeof fieldsLib.validateResponseFieldsShape === "function") {
              fieldsLib.validateResponseFieldsShape(
                required.response_fields,
                rowPath + ".response_fields",
                errors,
                required
              );
            }
      ...
      appendActivityResponseFulfilmentGate(activity, index, errors);
      appendActivityPracticeIndependenceGate(activity, index, errors);
      appendActivityDiagnosticReviewGate(activity, index, errors);
    }

    function appendActivityDiagnosticReviewGate(activity, index, errors) {
      var reviewLib = getDiagnosticReviewLib();
      if (
        !reviewLib ||
        typeof reviewLib.appendDiagnosticReviewValidationErrors !== "function"
      ) {
        return;
      }
      reviewLib.appendDiagnosticReviewValidationErrors(activity, index, errors);
    }

    function appendActivityPracticeIndependenceGate(activity, index, errors) {
      var independenceLib = getPracticeIndependenceLib();
      if (
        !independenceLib ||
        typeof independenceLib.appendPracticeIndependenceValidationErrors !== "function"
      ) {
        return;
      }
      independenceLib.appendPracticeIndependenceValidationErrors(activity, index, errors);
    }

    function appendActivityResponseFulfilmentGate(activity, index, errors) {
      var fulfilmentLib = getProductionFulfilmentLib();
      if (
        !fulfilmentLib ||
        typeof fulfilmentLib.appendResponseFulfilmentValidationErrors !== "function"
      ) {
        return;
      }
      fulfilmentLib.appendResponseFulfilmentValidationErrors(activity, index, errors);
    }
    ...
    function appendFacilitatedGroupingValidationErrors(page, options, errors) {
      if (!options || options.facilitatedDelivery !== true) return;
      if (
        !facilitatedDeliveryMod ||
        typeof facilitatedDeliveryMod.appendFacilitatedActivityGroupingValidationErrors !== "function"
      ) {
        return;
      }
      (Array.isArray(page.activities) ? page.activities : []).forEach(function (activity, index) {
        facilitatedDeliveryMod.appendFacilitatedActivityGroupingValidationErrors(
          activity,
          index,
          errors
        );
    ...
    function validateDlaPartialPageCapture(page, options) {
      ...
      appendFacilitatedGroupingValidationErrors(page, opts, errors);
