...
(function (root, factory) {
  ...
  function getGamWorkspaceFulfilmentLib() {
    if (typeof require === "function") {
      try {
        return require("./gam-workspace-fulfilment.js");
      } catch (_) {}
    }
    if (typeof globalThis !== "undefined" && globalThis.PRISM_GAM_WORKSPACE_FULFILMENT) {
      return globalThis.PRISM_GAM_WORKSPACE_FULFILMENT;
    }
    if (typeof window !== "undefined" && window.PRISM_GAM_WORKSPACE_FULFILMENT) {
      return window.PRISM_GAM_WORKSPACE_FULFILMENT;
    }
    return null;
  }

  function appendGamWorkspaceBlankCellGate(page, baseline, errors) {
    var lib = getGamWorkspaceFulfilmentLib();
    if (!lib || typeof lib.appendGamPageLearnerWorkspaceBlankCellErrors !== "function") return;
    lib.appendGamPageLearnerWorkspaceBlankCellErrors(page, baseline, errors);
  }
  ...
  function validateGamEnrichedPage(page, baseline) {
    ...
    appendGamWorkspaceBlankCellGate(page, baseline, errors);
  ...
  function validateGamPartialPageCapture(page, options) {
    var opts = options && typeof options === "object" ? options : {};
    var baseline = opts.baseline && typeof opts.baseline === "object" ? opts.baseline : null;
    var errors = [];
    if (!page || typeof page !== "object" || Array.isArray(page)) {
      return { ok: false, errors: ["page must be an object"] };
    }
