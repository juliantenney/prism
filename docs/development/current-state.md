...
- **Sprint 14 — Research Domain Runnable Maturity** (**active focus, first slice documented 2026-05-14**): Research pack + targeted **`app.js`** behaviour for **runnable** Factory quality—**not** a portability architecture sprint. **Map / charter / baseline / known issues:** `docs/consolidation/sprint-14-index.md`, `sprint-14-charter.md`, `sprint-14-research-pack-baseline-audit.md`, **`sprint-14-current-known-issues.md`** (**§§10–11** = completed vs remaining work; **E4.1**, **E4.3**, **E4.4**, **E4.5**, **I9.1** **mitigated**; **I9.2** **partially mitigated** with **Design Page** terminal + manual verification). **Local API-backed dev check:** **`npm run dev`** (**`scripts/dev-server.js`**, default **`127.0.0.1:8787`**). **Context:** **General baseline-only** — `sprint-13-general-alwayson-first-structured-domain-behaviour.md` §**Current v1**; **Sprint 12**/**13** first-pass closures **unchanged**. **Learning Design** elicitation parity **deferred** beyond Sprint **14** charter.
- **Cross-sprint architecture & portability backlog (descriptive only, not a roadmap):** [`docs/consolidation/prism-architecture-portability-backlog.md`](../consolidation/prism-architecture-portability-backlog.md) — unfinished themes after Sprint 12–13 consolidation; **no** implementation charter implied. **Sprint 14** is linked there as **practical runnable-pack work**, not portability redesign.
...
- Sprint 14 — **Research Domain Runnable Maturity** — **first implementation / verification slice + consolidation docs** (2026-05-14): index `docs/consolidation/sprint-14-index.md`; charter `sprint-14-charter.md`; baseline audit `sprint-14-research-pack-baseline-audit.md`; known issues `sprint-14-current-known-issues.md` (**mitigated:** **E4.1**, **E4.3**, **E4.4**, **E4.5**, **I9.1**; **partially mitigated:** **I9.2**). **`node --test tests/*.test.js`** green on consolidation pass. **Residual** renderer polish / naming / export audit — **known issues §11** only (**not** Sprint **12**/**13** reopeners).
