...
/**
 * S82-G2A spike — MathLive ↔ textarea TeX sync helpers (testable).
 * Canonical evidence remains textarea.value.
 */

var MATHLIVE_SPIKE_VERSION = "0.110.0";
...
function dispatchTextareaInput(textarea) {
  ...
  try {
    ...
    // IE legacy not required for spike
  }
}
