/**
 * LD-AUTHORIAL-EXPOSITION — Design Page assembly authorial quality (Sprint 42).
...
(function (root, factory) {
  ...
  var CORE_LINES = [
    ...
    "- Module: " +
      MODULE_ID +
      " | Design Page assembly only — authorial exposition on page wrapper prose (overview, learning_purpose, knowledge_summary, study_tips, and high-level section framing).",
  ...
  var PRESERVATION_BOUNDARY_LINES = [
    "- PRESERVATION BOUNDARY (partial contract + deterministic assembly owns these — authorial polish does not apply):",
    "  • Copy verbatim when present upstream: activity_preamble, learner_task, expected_output, support_note, all cognition-orientation fields in partial field preservation, and activity.materials.* / activity_materials bodies.",
