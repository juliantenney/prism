...
**Entry point for fresh chats:** [`sprint-44-chat-handover-pack.md`](sprint-44-chat-handover-pack.md)  
...
| Document | Role |
| -------- | ---- |
| [`sprint-44-chat-handover-pack.md`](sprint-44-chat-handover-pack.md) | **Single entry point** for fresh chats — settled ground, do-not-reopen list, next tasks |
...
| ----- | -------- | -------- |
| **44-1** Tiered GAM capture validation gate | Design spec | [`../2026-06-13-sprint-44-gam-capture-validation-gate/sprint-44-slice-1-tiered-gam-capture-gate.md`](../2026-06-13-sprint-44-gam-capture-validation-gate/sprint-44-slice-1-tiered-gam-capture-gate.md) |
| **44-2** Instructional depth contracts | Educational design spec (Draft 1) | [`../2026-06-15-sprint-44-instructional-depth-contracts/sprint-44-2-instructional-depth-contracts.md`](../2026-06-15-sprint-44-instructional-depth-contracts/sprint-44-2-instructional-depth-contracts.md) |
