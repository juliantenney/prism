...
(function (root, factory) {
  ...
  function buildDesignPagePartialContractBlock() {
    return [
      ...
      "- activities_visual_review[] — one row per upstream activity_id (use [] if empty)",
      "- visual_affordances[] — authoritative visual planning rows at page root (use [] if empty)",
      "- Follow the appended Sprint 38 visual affordance authoring contract for visual_decision, scope, subject, context, evidence_anchors, visual_slot, and related fields",
      "",
