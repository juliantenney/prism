...
- **Tomorrow:** confirm **Sprint 11** pass scope against `docs/consolidation/sprint-11-workflow-generation-fixture-regression-foundations.md` (**entry / exit criteria, §§11–12**); **no** application code or fixture files until scope is agreed — **Sprint 11 not started**.
