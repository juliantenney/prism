...
(function (root, factory) {
  ...
  function buildDlaPageEnrichContractBlock() {
    return [
      ...
      "",
      "Verification checklist diagnostic specification (when S78-WS-3 trigger applies — substantive independent learner production, not guided-only):",
      "- Commission exactly one checklist row with diagnostic_review.covers_response_material_ids listing every response_fulfilment material_id on this activity.",
