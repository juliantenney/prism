/**
 * LD-JOURNEY-ASSIMILATION — Design Page assembly journey expression (Sprint 42-6).
...
(function (root, factory) {
  ...
  var CORE_LINES = [
    ...
    "- Module: " +
      MODULE_ID +
      " | Design Page assembly only — assimilate existing upstream journey signals into wrapper/page-level prose (overview, learning_purpose, knowledge_summary, study_tips, and high-level section framing).",
  ...
  var TRANSITION_LINES = [
    ...
    "  • When learning_sequence.timeline[] is bound, assimilate transition_to_next as 30–60 words of conceptual continuity prose per transition — what was established, why the next activity follows, what reasoning move the learner makes.",
    "  • FORBIDDEN: scheduling-only transitions (Next complete…, Then do…, Move to Activity 2…, Session ends with… as the only content).",
