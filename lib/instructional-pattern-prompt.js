...
(function (root, factory) {
  ...
  var SP05_LINES = [
    ...
    "- When emitting Material: ... (checklist): every checklist body MUST provide criteria-linked learner self-check verification — not pointer stub, reflection-only list, or generic completion audit.",
    "- MUST include at least four checkable items tied to expected_output or activity criteria (GAM-PRES-08 (V1) when verification).",
    "- MUST use learner-check imperatives (Have you / Did you / Does your) on every item.",
    "- After check items, MUST include `## Common mistakes` (2–4 discipline-specific novice traps) — diagnostic, not motivational.",
    "- MUST end with `### If any check is not met:` followed by specific, actionable revision moves — not generic advice.",
