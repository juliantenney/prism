...
(function (root, factory) {
  ...
  function (contractMod, plannerMod, compilerMod, assetsMod, houseVisualMod) {
    "use strict";
    ...
    if (
      ...
      throw new Error(
        "utilities-visual-jobs-workspace requires visual planning pipeline, visual asset modules, and house visual language"
      );
    }
    ...
    function buildAuthorisedEvidenceLines(brief) {
      ...
      for (var i = 0; i < sources.length; i++) {
        ...
        if (clipped.length > budget) {
          clipped = clipped.slice(0, Math.max(0, budget - 3)) + "...";
        }
