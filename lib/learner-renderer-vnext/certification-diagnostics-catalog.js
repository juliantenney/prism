...
var CATALOG = Object.freeze([
  Object.freeze({
    ...
    condition:
      "Historical (retired Phase 5B): exact whole-sequence registry miss. Production validation no longer emits this code."
  }),
  Object.freeze({
    ...
    expectedInSuccessfulAuthoritativeRender: false,
    mayIncludeResponseContent: false,
    condition: "Activity episode_plan.archetype is missing or is not a frozen Episode Plan V1 archetype."
  }),
  Object.freeze({
    code: "ARCHETYPE_GRAMMAR_VALIDATION_FAILED",
    subsystem: "archetype",
    severity: "error",
    releaseBlocking: true,
    expectedInSuccessfulAuthoritativeRender: false,
    mayIncludeResponseContent: false,
    condition:
      "Canonical FunctionEnum sequence failed shared archetype grammar validation (sole educational legality authority)."
  }),
  Object.freeze({
    code: "UNKNOWN_EPISODE_PLAN_BEAT",
    subsystem: "archetype",
    severity: "error",
    releaseBlocking: true,
    expectedInSuccessfulAuthoritativeRender: false,
    mayIncludeResponseContent: false,
    condition:
      "Beat values are outside FunctionEnum (including non-canonical compressed vocabulary)."
  }),
  Object.freeze({
    code: "MIXED_EPISODE_PLAN_VOCABULARY",
    subsystem: "archetype",
    severity: "error",
    releaseBlocking: true,
    expectedInSuccessfulAuthoritativeRender: false,
    mayIncludeResponseContent: false,
    condition:
      "Sequence mixes FunctionEnum with non-canonical compressed vocabulary; fail closed."
  }),
  Object.freeze({
    code: "MALFORMED_EPISODE_PLAN_SEQUENCE",
    subsystem: "archetype",
    severity: "error",
    releaseBlocking: true,
    expectedInSuccessfulAuthoritativeRender: false,
    mayIncludeResponseContent: false,
    condition: "Episode plan beat sequence is empty or contains empty beat functions."
  }),
  Object.freeze({
    code: "ARCHETYPE_GRAMMAR_REJECTS_REGISTERED_SEQUENCE",
    subsystem: "archetype",
    severity: "info",
    ...
    mayIncludeResponseContent: false,
    condition:
      "Historical observational code from Sprint 69 dual-validation era; runtime registry removed in Phase 5B."
  }),
  Object.freeze({
    code: "ARCHETYPE_GRAMMAR_ACCEPTS_UNREGISTERED_SEQUENCE",
    subsystem: "archetype",
    severity: "info",
    releaseBlocking: false,
    expectedInSuccessfulAuthoritativeRender: true,
