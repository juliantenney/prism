...
(function (root, factory) {
  ...
  var PRESERVE_LINES = [
    ...
    "- Table fidelity overrides session overview synthesis, brevity, and non-essential prose shortening for materials.<table_key> bodies — adjunct guidance is L4-faithful instructional content, not L7 shorten-able overview prose."
  ];
