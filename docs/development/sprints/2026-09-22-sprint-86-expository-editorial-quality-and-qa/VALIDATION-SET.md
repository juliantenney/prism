...
## Case 01 — Bayes' theorem (baseline; generated)

| Field | Value |
| ----- | ----- |
| Status | **Captured** — do not regenerate for baseline |
| Type | Conceptual / quantitative · worked example · representation-important |
| Why retained | Strong instructional architecture + editorial shortfalls; calibration case for v0.1 |

---

## Case 02 — Semi-structured interview protocol (procedural; low-visual)
...
## Case 03 — Natural selection vs Lamarckian inheritance (mechanism contrast; visual-important)
...
## Case 04 — Historians’ disagreement on the causes of the First World War (interpretive; evidence/qualification)
...
## Case 05 — Deductive validity vs everyday persuasiveness (abstract; challenges stock openings)
...
## Coverage checklist (selection intent)

| Challenge requirement | Satisfied by |
| --------------------- | ------------ |
| Little/no graphical material | C02, C05 |
| Representation materially important | C03 (and C01) |
| Challenges obvious problem/question-style opening | C05 (also C04) |
| Interpretation / evidence / qualification / competing perspectives | C04 |
| Conceptual vs procedural | C01/C05 vs C02 |
| Quantitative vs qualitative | C01 vs C04/C05 |
| Technical vs humanities | C03 vs C04 |
