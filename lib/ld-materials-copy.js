...
(function (root, factory) {
  ...
  var ARCHIVAL_FIELD_LINES = [
    ...
    "- Transport slots (upstream body or omit; not authored here): knowledge_summary (when LC/KM bound), study_tips (when upstream provides closure/debrief), overview and learning_purpose (thin assembly-coherence or upstream transport only).",
  ...
  var PRESERVE_LINES = [
    ...
    "- Readable page assembly applies to section structure, headings, ordering, and transport-slot assembly only — not to rewriting activity.materials.* bodies.",
    ...
    "- overview / learning_purpose: thin assembly-coherence or upstream transport only — not summary-only substitutes for activity.materials.* bodies.",
