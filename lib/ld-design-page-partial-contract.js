...
(function (root, factory) {
  ...
  function buildDesignPagePartialContractBlock() {
    return [
      ...
      "- Follow the appended Sprint 38 visual affordance authoring contract for visual_decision, scope, subject, context, evidence_anchors (canonical activity_id.path or page_synthesis.field strings only), visual_slot, activities_visual_review.rationale, and related fields",
      "",
