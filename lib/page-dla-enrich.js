...
(function (root, factory) {
  ...
  if (typeof module === "object" && module.exports) {
    ...
    module.exports = factory(populationContract, beatRegistry);
  } else {
    populationContract = root.PRISM_EPISODE_PLAN_POPULATION;
    beatRegistry = root.PRISM_BEAT_MATERIAL_REGISTRY;
    root.PRISM_PAGE_DLA_ENRICH = factory(populationContract, beatRegistry);
  }
})(
  typeof globalThis !== "undefined" ? globalThis : typeof window !== "undefined" ? window : this,
  function (populationContract, beatRegistry) {
    "use strict";
