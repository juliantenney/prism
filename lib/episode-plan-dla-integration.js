...
(function (root, factory) {
  ...
  function buildDlaPopulationOnlyPromptBlock() {
    ...
    try {
      var titleMod =
        (typeof module === "object" && module.exports
          ? require("./ld-activity-title-contract.js")
          : null) ||
        (typeof globalThis !== "undefined" && globalThis.PRISM_LD_ACTIVITY_TITLE_CONTRACT) ||
        (typeof window !== "undefined" && window.PRISM_LD_ACTIVITY_TITLE_CONTRACT) ||
        null;
      if (titleMod && typeof titleMod.buildDlaActivityTitleGuidance === "function") {
        titleGuidance = titleMod.buildDlaActivityTitleGuidance();
      }
    } catch (_) {}
    if (!titleGuidance) {
      titleGuidance = [
    ...
    return [
      ...
      "",
      "**Final learner-facing activity titles:** replace any provisional Episode Plan shell title with a designed activities[].title.",
      titleGuidance,
      "",
      "**Scaffold strings:** SSOT page copy — see LD-GUIDED-LEARNING-SCAFFOLD-CONTRACT (do not compress beats into scaffold fields).",
      "",
