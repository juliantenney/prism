...
(function (root, factory) {
  ...
  var CONTRACT_VERSION = "76-DLA-PARTIAL-5";
  ...
  function buildDlaPageEnrichContractBlock() {
    return [
      ...
      "5) If evidence_decision.required is true: provider_material_ids must be a subset of task_input_material_ids; those rows carry evidence_requirement. If false: provider_material_ids empty and no evidence_requirement rows.",
      "",
