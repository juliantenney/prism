 ...
 * Does not duplicate: LD-MATERIALS-COPY archival transport, removed wrapper stack.
 */
(function (root, factory) {
  ...
  var CORE_LINES = [
    ...
    "- Precedence: obey partial Design Page contract and embedded LD-MATERIALS-COPY / LD-TABLE-FIDELITY preserve roles — this block does not override archival transport or field preservation."
  ];
  ...
  var TRANSPORT_FIRST_LINES = [
    ...
    "  3. study_tips — transport the GAM Markdown section headed \"### Page learner-resource closure\" when present (verbatim body only); omit when none. Bridge must not author or synthesize.",
  ...
  var PRESERVATION_LINES = [
    "- PRESERVATION (hard):",
    "  • activity.materials.*, activity-row scaffold fields, episode_plan beats, and assessment items — transport verbatim per partial upstream contracts; bridge does not read GAM Content: to summarise into wrapper prose.",
