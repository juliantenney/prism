  ...
  var panels = guided
    .map(function (criterion, index) {
      ...
      var whyHtml = criterion.whyItMatters
        ...
        : "";
      var reviseHtml =
        opts.revisionAccompaniment && opts.activityId
          ? revisionAccompaniment.renderReviseWithCriterionAction(
              opts.activityId,
              criterion.id,
              html
            )
          : "";
      return (
        '<section class="util-guided-review__panel" data-revision-criterion-root data-guided-review-index="' +
      ...
      .map(function (criterion, index) {
        ...
        var reviseHtml =
          opts.revisionAccompaniment && opts.activityId
            ...
            : "";
        return (
          '<div class="util-interactive-checklist__item" data-revision-criterion-root data-revision-criterion-id="' +
          html.escapeAttribute(itemId) +
          '">' +
          '<input type="checkbox" class="util-interactive-checklist__input" id="' +
...
function renderMaterial(material, options) {
  ...
  var bodyOptions = {
    ...
    revisionAccompaniment: !!opts.revisionAccompaniment
  };
