...
| WP3 | Pedagogical sibling prompts | Real topic yields coherent north-star journey | **COMPLETE** |
...
| S85-T-005 | Domain-pack propagation initial trace (General + selected domain → stages) | WP1/WP3 | **COMPLETE** — WGC design + Run Expository domain-guidance injection verified |
...
| S85-T-009 | Expository sibling prompts: GLC, LO | WP3 | **COMPLETE** |
| S85-T-010 | Expository sibling prompts: EJP, XD, XM | WP3 | **COMPLETE** |
| S85-T-011 | Expository sibling prompt: Design Page | WP3 | **COMPLETE** |
...
| S85-T-014 | Decide GAM body-authoring reuse behind XM (document decision) | WP3/WP4 | **COMPLETE** (S85-D06 — no GAM Interactive reuse) |
