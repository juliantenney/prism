...
(function (root, factory) {
  ...
  function buildLearnerPackage(input) {
    ...
    if (typeof require === "function") {
      var mathEntryAssets = null;
      try {
        mathEntryAssets = require("./learner-renderer-vnext/math-entry-package-assets");
        if (mathEntryAssets.pageHtmlNeedsMathEntry(htmlOut)) {
          var mathLiveFiles = mathEntryAssets.collectMathLivePackageAssets({
        ...
        if (htmlOut.indexOf('data-input-modality="math"') >= 0) {
          return {
            ok: false,
            warnings: warnings,
            error: {
