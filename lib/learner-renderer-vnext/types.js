...
/**
 * @typedef {Object} GuidedChecklistFeature
 * @property {string} expected
 * @property {string} repair
 */

/**
 * @typedef {Object} GuidedChecklistCriterion
 * @property {string} id
 * @property {string} statement
 * @property {string|null} whyItMatters
 * @property {GuidedChecklistFeature[]} features
 * @property {string} confirmationLabel
 */

/**
 * @typedef {Object} ChecklistModel
 * @property {"simple"|"guided_review"} mode
 * @property {string[]} criteria
 * @property {string|null} revisionInstruction
 * @property {GuidedChecklistCriterion[]|null} guidedCriteria
 */
...
/**
 * Assembled Expository resource section (semantic primary structure).
 * @typedef {Object} ExpositionSection
 * @property {string} id
 * @property {string} title
 * @property {string} explanation learner-facing exposition prose (from section.exposition)
 * @property {number} order
 * @property {LearnerMaterial[]} materials
 * @property {VisualAffordanceHook|null=} visualAffordanceAfterContent
 */
 ...
 * @property {string} title
 * @property {"expository"|"interactive"} pageKind
 * @property {Object} sessionFraming
 * @property {PageHeader} header
 * @property {OrientationSection[]} orientationSections
 * @property {ExpositionSection[]} expositionSections
 ...
 * @property {VisualAffordanceHook|null=} visualAffordanceAfterKnowledgeSummary
...
/**
 * @typedef {"orient"|"learn"|"do"|"check"|"transfer"|"reflect"|"transition"} CompositionMomentKind
 */
 ...
 * @property {string=} responsePartId
 ...
 * @property {"text"|"math"} [inputModality]
 */
 ...
 * @property {CompositionMoment|null=} transferMoment
 * @property {boolean} suppressFraming
 * @property {string[]} omitBeatFunctions
 * @property {Object.<string, { omitInstructionSteps: number[], omitMaterialIds: string[], omitExpectedOutput: boolean }>} suppressBeatContent
 * @property {string=} learnMomentBeat
 ...
 * @property {{ manifest_version?: string, assets?: object[] }|null=} visualAssets
 */
