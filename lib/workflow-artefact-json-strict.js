/**
 * Strict JSON-only workflow artefact capture validation (Model Knowledge, Learning Sequence).
 */
(function (root, factory) {
  ...
  function validateWorkflowStepStrictJsonCapture(raw, stepKind, sanitizeFn) {
    ...
    if (kind !== "knowledge_model" && kind !== "learning_sequence") {
    ...
    var capture = parseFencedJsonObjectCapture(
      raw,
      sanitizeFn,
