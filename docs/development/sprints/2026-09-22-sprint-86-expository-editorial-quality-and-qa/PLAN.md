...
| **WP5** | Typography requirements + successor design | Editorial rendering requirements (not CSS); bounded implementation recommendation | **NOT STARTED** — next when authorised |
...
| S86-T-010 | Record typography / editorial rendering requirements (principles only) | WP5 | **PENDING** — next |
