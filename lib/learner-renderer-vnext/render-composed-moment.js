...
function renderLearnerWorkspace(workspace, activityId, options) {
  ...
  var mathSpikeAttrs =
    inputModality === "math"
      ? ' data-input-modality="math" data-math-entry-spike="true" data-math-label-id="' +
        html.escapeAttribute(labelId) +
        '"'
      : "";
  var mathSpikeClass = inputModality === "math" ? " util-learner-workspace--math-spike" : "";

  var inputHtml =
    inputModality === "math"
      ? '<div class="util-math-entry-spike" data-math-entry-spike-root>' +
        '<div class="util-math-entry-spike__mount" data-math-entry-mount hidden></div>' +
        ...
        describedByAttr +
        "></textarea>" +
        '<p class="util-math-entry-spike__hint util-math-entry-spike__hint--fallback-only" id="' +
        html.escapeAttribute(hintId) +
        '">If the maths editor is unavailable, enter TeX notation in this field.</p>' +
        "</div>"
