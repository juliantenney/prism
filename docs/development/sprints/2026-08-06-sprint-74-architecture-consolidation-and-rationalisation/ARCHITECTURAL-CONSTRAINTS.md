...
**Sprint 74A is COMPLETE / Closed** — [SPRINT-74A-FINAL-REPORT.md](../2026-08-06-sprint-74a-authoring-learner-export-path-integrity/SPRINT-74A-FINAL-REPORT.md). **Sprint 74B is COMPLETE / Closed** — [SPRINT-74B-START-HERE.md](../2026-08-07-sprint-74b-generation-contract-capture-validator-hygiene/SPRINT-74B-START-HERE.md). **Sprint 74C is OPEN** (narrowed repository hygiene — [post-74B review](S74-programme-post-74B-review.md) R1) — [SPRINT-74C-START-HERE.md](../2026-08-07-sprint-74c-repository-hygiene-and-historical-residue-rationalisation/SPRINT-74C-START-HERE.md). Sprint 75 remains **Not opened**.
