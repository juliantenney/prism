...
(function (root, factory) {
  ...
  var DP = [
    ...
    "- purpose / preferred_representation / representation_avoid use the established controlled vocabularies (purpose includes synthesis/mechanism; preferred_representation includes process, causal_chain, concept_map, annotated_system, …).",
